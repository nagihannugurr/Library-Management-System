...
class Library:
    ...
    def add_book(self, bid, name, copies, authors):
        #_book = Book(bid, name, copies, authors)
    ...
    def remove_book(self):
            ...
            print("\nDeleted from authors & books list:",book_to_del)
            #print("Books:",self.author_to_books)
    ...
    def list_book(self):
        ...
        for i in Library.book_objects:
            list_of_books.append(str(Library.book_objects[i][0]))

        return list_of_books

    def list_authors_books(self):
        list_of_authors= []
        for x,y in self.author_to_books.items():
            list_of_authors.append(str(y))
...
class Main:
    ...
    def show_admin_menu(self):
        ...
        while True:
            ...
            if number == 1:
                print("\nBooks:",self.library.list_book())
                print("Authors & Books: ",self.library.list_authors_books())
            elif number == 2:
                bid=input("Book ID: ")
                name=input("Name: ")
                copies=input("Copies: ")
